...
document.addEventListener('DOMContentLoaded', () => {
    const initialCoords = [13.927426942524999, -89.83928383200168];
...
function enviarUbicacionEnTiempoReal() {
  ...
  ubicacionTexto.innerHTML = '<p style="margin-left: 40px;">Estado: Compartiendo ubicación...</p>';
...
function enviarAFirestore(position) {
    ...
    db.collection("ubicaciones").doc("51-F").set({
        latitude: lat,
        longitude: lng,
